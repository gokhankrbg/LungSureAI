...
with tabs[1]:
    ...
    with tabs[2]:
        ...
        st.image("CAT_shap.png", caption="CatBoost SHAP", use_column_width=True)
        st.image("LGBM_shap.png", caption="LGBM SHAP", use_column_width=True)
        st.image("XG_shap.png", caption="XGBoost SHAP", use_column_width=True)
        st.image("RF_shap.png", caption="RF SHAP", use_column_width=True)
